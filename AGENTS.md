...
- `(pending)` isSyncing flag + sync upsert/merge + double-prime guard + key uniqueness + snapshot keys (REP-142,155,167,168,171, worker-2026-04-23-025721)
